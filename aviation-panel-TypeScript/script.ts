...
class AviationInstrumentPanel {
  ...
  // DOM elements
  private elements: InstrumentElements;
  ...
  constructor() {
    ...
    this.elements = {} as InstrumentElements;
  ...
  private initializeElements(): void {
    ...
    this.elements.airspeedControl = document.getElementById('airspeed-control') as HTMLInputElement;
    ...
    this.elements.verticalSpeedControl = document.getElementById('vertical-speed-control') as HTMLInputElement;
    ...
    this.elements.altitudeControl = document.getElementById('altitude-control') as HTMLInputElement;
    ...
    this.elements.turnRateControl = document.getElementById('turn-rate-control') as HTMLInputElement;
    ...
    this.elements.pitchControl = document.getElementById('pitch-control') as HTMLInputElement;
    ...
    this.elements.headingControl = document.getElementById('heading-control') as HTMLInputElement;
  ...
  private bindEvents(): void {
    if (this.elements.airspeedControl) {
      this.elements.airspeedControl.addEventListener('input', (e: Event) => {
    ...
    if (this.elements.altitudeControl) {
      this.elements.altitudeControl.addEventListener('input', (e: Event) => {
        const target = e.target as HTMLInputElement;
    ...
    if (this.elements.verticalSpeedControl) {
      this.elements.verticalSpeedControl.addEventListener('input', (e: Event) => {
        const target = e.target as HTMLInputElement;
    ...
    if (this.elements.turnRateControl) {
      this.elements.turnRateControl.addEventListener('input', (e: Event) => {
        const target = e.target as HTMLInputElement;
    ...
    if (this.elements.headingControl) {
      this.elements.headingControl.addEventListener('input', (e: Event) => {
        const target = e.target as HTMLInputElement;
    ...
    if (this.elements.pitchControl) {
      this.elements.pitchControl.addEventListener('input', (e: Event) => {
        const target = e.target as HTMLInputElement;
  ...
  private updateAirspeed(value: string): void {
  ...
  private updateAltitude(value: string): void {
  ...
  private updateVerticalSpeed(value: string): void {
  ...
  private updateTurnRate(value: string): void {
  ...
  private updateHeading(value: string): void {
  ...
  private updatePitch(value: string): void {
  ...
  private createVSIMarkings(): void {
